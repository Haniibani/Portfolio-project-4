...
class CommentFormTest(TestCase):
    ...
    def test_valid_data(self):
        ...
        """
        form = CommentForm(data={'name': 'John Doe', 'body': 'This is a valid comment.'})
    ...
    def test_invalid_data_type(self):
        ...
        long_comment = 'a' * 1001  # Create a long comment with more than 1000 characters
    ...
    def test_clean_special_characters(self):
        ...
        """
        recipe = Recipe.objects.create(title="Test Recipe", estimated_time=30)
        special_character_comment = 'Test Comment with special characters !@#$%^&*()'
